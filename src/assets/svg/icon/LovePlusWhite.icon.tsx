...
const LovePlusWhiteIcon: React.FC<JSX.IntrinsicElements["svg"]> = (props) => {
  return (
    <svg
      width="1em"
      height="1em"
    ...
    >
      ...
      <path
        ...
        fill="#fff"
      />
      <circle cx={20.005} cy={12.024} r={1.068} fill="#fff" />
      <circle cx={13.929} cy={18.296} r={1.03} fill="#fff" />
    </svg>
  )
}

export default LovePlusWhiteIcon
